...
def flash_manchete(news):
    ...
    prompt = (
        ...
        "REGRA DE OURO (dado do dono: chamada COM nome de cidade faz 3-10 mil views, sem faz "
        "200): o NOME DA CIDADE (" + cidade + ") DEVE aparecer na chamada quando a noticia for "
        "de cidade especifica — de preferencia logo no comeco. PROIBIDO: "
